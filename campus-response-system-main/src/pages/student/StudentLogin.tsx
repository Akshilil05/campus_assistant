    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-blue-100 via-purple-100 to-pink-200">
      <Card className="w-full max-w-md p-8 shadow-lg">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <Button type="submit" className="w-full bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 text-white font-semibold shadow-md hover:scale-105 hover:shadow-[0_0_15px_rgba(147,51,234,0.8)] transition-all duration-200" disabled={loading}>
